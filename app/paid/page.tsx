    ...
    >
      ...
      <footer className="bg-gradient-to-b from-gray-50 via-white to-gray-100 border-t border-gray-200 mt-20">
        <div className="max-w-7xl mx-auto px-6 py-16">
          {/* Main Footer Content - PAID embed: no legal links */}
          <div className="flex flex-col items-center justify-center text-center mb-8">
            ...
            {/* Contact Info - Simple for customer-facing embed */}
            <div className="space-y-3 text-sm text-gray-500">
              ...
              <p className="flex items-center justify-center">
                ...
                <a href="tel:+14047702672" className="hover:opacity-80 transition-colors">+1 (404) 770-2672</a>
              </p>
            </div>
          </div>
