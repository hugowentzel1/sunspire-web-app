          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500">
                    30% commission on all recurring payments, paid monthly
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500">
                    Sales materials, case studies, and co-marketing
                    opportunities
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500">
                    Resell under your own brand with custom pricing
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500">
                    Track commissions, leads, and performance in real-time
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <p className="text-gray-600 italic mb-3">
                &ldquo;We&apos;ve generated over $15,000 in recurring revenue in
                just 6 months by recommending{" "}
                {b.enabled ? b.brand : "Your Company"} to our solar clients. The
                commission payments are reliable and the product sells
                itself.&rdquo;
              </p>
