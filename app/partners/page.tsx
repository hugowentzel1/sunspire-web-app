    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-16 sm:py-8">
        ...
        <div className="grid grid-cols-[1fr_1.1fr] gap-8 md:gap-6">
          {/* Left Column - Commission/Benefits */}
          <div className="space-y-6">
            {/* Commission Structure */}
            <div className="bg-white rounded-xl border border-neutral-200/60 shadow-sm p-6 sm:p-5">
              <h3 className="text-xl font-semibold text-neutral-900 mb-4">Commission Structure</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-neutral-500">Standard Plan ($99/month)</span>
                  <span className="font-bold" style={{ color: 'var(--brand-primary)' }}>$30/month recurring</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-neutral-500">Setup Fee ($399)</span>
                  <span className="font-bold" style={{ color: 'var(--brand-primary)' }}>$120 one-time</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-neutral-500">Enterprise Deals</span>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-neutral-900">Partner Benefits</h3>
