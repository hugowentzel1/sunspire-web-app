      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-gray-200/50 shadow-lg">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-600 mb-6">
              Build custom solar lead management workflows with Airtable&apos;s
              flexible database
            </p>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Set up a new Airtable base with tables for Leads,
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Set up custom fields for solar-specific data and
                      calculations
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Create automations for notifications and follow-up
                      sequences
                    </p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Get notified when new leads are added or quotes are
                    generated
                  </p>
                </div>
                ...
                <div className="text-center space-y-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Automatically schedule follow-up tasks and reminders
                  </p>
                </div>
                ...
                <div className="text-center space-y-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Calculate lead scores based on property data and energy
                    usage
                  </p>
                </div>
                ...
                <div className="text-center space-y-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Generate custom reports on lead conversion and performance
                  </p>
                </div>
              </div>
            </section>
