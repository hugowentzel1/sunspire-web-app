          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Create Connected App</h3>
                    <p className="text-gray-600">Set up a Connected App in Salesforce Setup → App Manager</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Copy Consumer Key and Consumer Secret from your Connected App</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Configure Custom Fields</h3>
                    <p className="text-gray-600">Add custom fields to Lead and Opportunity objects for solar data</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Set Up Workflow Rules</h3>
                    <p className="text-gray-600">Create automation for lead assignment and follow-up tasks</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Lead Fields</h3>
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                      ...
                      <span className="text-sm text-gray-600">Roof Size (sq ft)</span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                      <span className="font-medium">Monthly_Energy_Usage__c</span>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Opportunity Fields</h3>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                      <span className="font-medium">System_Size_kW__c</span>
                      <span className="text-sm text-gray-600">System Size (kW)</span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
            ...
            <section className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center space-y-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">Lead Assignment</h3>
                  <p className="text-sm text-gray-600">Automatically assign leads to sales reps based on territory</p>
                </div>

                <div className="text-center space-y-4">
                  <div className="w-16 h-16 mx-auto bg-gradient-to-br from-[var(--brand-primary)] to-white rounded-2xl flex items-center justify-center shadow-lg">
                    <svg className="w-8 h-8 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5 5v-5zM4 19h6v-6H4v6zM4 13h6V7H4v6zM10 7v6h6V7h-6z" />
                    </svg>
                  </div>
                  <h3 className="text-lg font-semibold text-gray-900">Task Creation</h3>
                  <p className="text-sm text-gray-600">Create follow-up tasks and calendar events automatically</p>
                </div>
