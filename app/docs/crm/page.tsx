        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <nav className="hidden md:flex items-center space-x-12">
              <Link href="/pricing" className="text-gray-600 hover:text-[var(--brand-primary)] transition-colors font-medium">Pricing</Link>
              <Link href="/partners" className="text-gray-600 hover:text-[var(--brand-primary)] transition-colors font-medium">Partners</Link>
              <Link href="/support" className="text-gray-600 hover:text-[var(--brand-primary)] transition-colors font-medium">Support</Link>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <div className="space-y-4">
            <h1 className="text-4xl md:text-5xl font-black text-gray-900">CRM Integration Guides</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">HubSpot Integration</h3>
              <p className="text-gray-600 mb-6">
                Connect your solar tool with HubSpot CRM for seamless lead management and automation.
              </p>
              <Link 
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                Integrate with Salesforce CRM to track leads, opportunities, and customer data.
              </p>
              <Link 
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Airtable Integration</h3>
              <p className="text-gray-600 mb-6">
                Connect with Airtable for flexible database management and custom workflows.
              </p>
              <Link 
