        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-gray-200/50 shadow-lg">
          ...
          <div className="prose prose-lg max-w-none">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Complete your company profile and branding configuration</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Domain Configuration</h3>
                    <p className="text-gray-600">Connect your website domain and set up SSL certificates</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Widget Integration</h3>
                    <p className="text-gray-600">Add the one-line script to your website</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">CRM Connection</h3>
                    <p className="text-gray-600">Connect your CRM system for lead management</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Test the system and go live with your branded tool</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-3">Add to your website</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">Add to your theme&apos;s footer.php or use a custom HTML widget</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-900 mb-2">Shopify</h4>
                    <p className="text-sm text-gray-600">Add to your theme.liquid file in the &lt;/body&gt; section</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-900 mb-2">Wix</h4>
                    <p className="text-sm text-gray-600">Use the HTML embed element in your page editor</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-900 mb-2">Custom HTML</h4>
                    <p className="text-sm text-gray-600">Add the script tag anywhere in your HTML</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-sm text-gray-600">Automatic contact creation and deal tracking</p>
                  <a href="/docs/crm/hubspot" className="inline-flex items-center text-[var(--brand-primary)] hover:underline font-medium">
                    View Guide
                ...
                <div className="text-center space-y-4">
                  ...
                  <p className="text-sm text-gray-600">Lead and opportunity management integration</p>
                  <a href="/docs/crm/salesforce" className="inline-flex items-center text-[var(--brand-primary)] hover:underline font-medium">
                    View Guide
                    <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                ...
                <div className="text-center space-y-4">
                  ...
                  <p className="text-sm text-gray-600">Custom database and workflow automation</p>
                  <a href="/docs/crm/airtable" className="inline-flex items-center text-[var(--brand-primary)] hover:underline font-medium">
                    View Guide
                    <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">Average response time: 45ms</p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">Global distribution active</p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-center">
                  <a href="/status" className="inline-flex items-center text-[var(--brand-primary)] hover:underline font-medium">
