        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-gray-200/50 shadow-lg">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-600 mb-6">
              Exercise your right under the California Consumer Privacy Act
              (CCPA) to opt out of the sale of your personal information.
            </p>
            {!submitted ? (
              <div className="space-y-6">
                ...
                <p className="text-gray-700">
                  Under the CCPA, you have the right to opt out of the sale of
                  your personal information. Please note that Sunspire does not
                  sell personal information to third parties for monetary
                  consideration. However, we provide this form to ensure
                  compliance with all CCPA requirements.
                </p>
                ...
                <div className="bg-gray-50 rounded-lg p-6 mt-6 border border-gray-200">
                  ...
                  <ul className="text-gray-700 text-sm space-y-1">
                    ...
                    <li>
                      • This applies to future data collection and processing
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="text-center space-y-6">
                ...
                <p className="text-gray-700">
                  Thank you for submitting your opt-out request. We will process
                  it within 15 business days and send you a confirmation email
                  at {email}.
                </p>
                <button
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p className="mt-4">
                  ...
                  or contact us at{" "}
                  <a
                    href="mailto:privacy@sunspire.app"
                    className="hover:underline"
                  >
