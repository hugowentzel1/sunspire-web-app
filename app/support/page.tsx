...
export default function SupportPage() {
  ...
  return (
    <div 
      className="min-h-screen bg-gradient-to-br from-slate-50 via-[var(--brand-50)] to-[var(--brand-100)] font-inter"
      data-brand
    >
      <Section>
        <Container>
          <Stack>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mt-10 md:mt-16">
              ...
              <Card>
                <div className="text-center space-y-2">
                  <div className="w-12 h-12 bg-gradient-to-br from-gray-400 to-gray-100 rounded-full flex items-center justify-center mx-auto shadow-lg">
                    <svg className="w-6 h-6 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
