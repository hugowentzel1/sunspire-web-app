          ...
          >
            ...
            <div className="mt-12">
              ...
              <div className="space-y-3">
                <a href="/methodology" className="block text-green-600 hover:text-green-700">
                  📊 Calculation Methodology
                </a>
                <a href="/enterprise" className="block text-green-600 hover:text-green-700">
                  🏢 Enterprise Features
                </a>
                <a href="/partners" className="block text-green-600 hover:text-green-700">
                  🤝 Partner Program
                </a>
                <a href="mailto:setup@sunspire.app" className="block text-green-600 hover:text-green-700">
                  ⚡ Setup Assistance
                </a>
              </div>
            </div>
