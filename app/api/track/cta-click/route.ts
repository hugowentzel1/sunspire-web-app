...
async function handleCtaClick(req: AuthenticatedRequest): Promise<NextResponse> {
  try {
    ...
    if (email) {
      ...
      logger.info('Lead upserted for CTA click tracking:', { email, tenant: tenant.handle });
    }
