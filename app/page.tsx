      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center space-y-6">
          ...
          <div 
            ...
            style={{ 
              background: 'linear-gradient(135deg, white, white, rgba(0, 113, 227, 0.25))',
            }}
          >
            <div 
              className="absolute inset-0 opacity-100"
              style={{
                background: 'linear-gradient(135deg, transparent, rgba(255,255,255,0.6), rgba(0, 113, 227, 0.4))',
              }}
            ></div>
