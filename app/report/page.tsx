          ...
          >
            ...
            <div data-testid="hdr-meta" className="mx-auto mt-4 w-full max-w-sm">
              ...
              {demoMode && (
                ...
                {/* Metric Tiles */}
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4, duration: 0.8 }} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-stretch" style={{ marginTop: '24px' }}>
