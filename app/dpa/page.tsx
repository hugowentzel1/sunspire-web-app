          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                ...
                the Terms of Service between Sunspire (&quot;Data
                Processor&quot;) and the customer (&quot;Data Controller&quot;)
                for the processing of personal data in connection with our solar
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-600">
                <li className="text-[var(--brand-primary)]">
                  Providing solar analysis and quote generation services
                </li>
                <li className="text-[var(--brand-primary)]">
            ...
            <section className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-3 bg-gray-50 rounded-lg">
                  <strong>Right of Access:</strong> Request information about
                ...
                <div className="p-3 bg-gray-50 rounded-lg">
                  <strong>Right to Portability:</strong> Receive personal data
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-600">
                ...
                <li className="text-[var(--brand-primary)]">
                  Cooperate with relevant authorities and Data Controller
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Sunspire may engage subprocessors to assist in providing
                services. All subprocessors are bound by data protection
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                ...
                fulfill the purposes outlined in this agreement, unless a longer
