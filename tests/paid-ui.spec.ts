...
test('Paid: demo/ops copy removed; hero logo; sticky actions; white-label footer; cookie-safe', async ({ page }) => {
  ...
  await expect(sticky.getByRole('button', { name: /Book Consultation/i })).toBeVisible();
