...
test('Final Test - 2 Reports Then Lockout', async ({ page }) => {
  console.log('🎯 Final test - 2 reports then lockout on third click...');
  ...
  // Take screenshot
  await page.screenshot({ path: 'final-2-reports-test.png', fullPage: true });
  
  console.log('🎉 Final test passed - 2 full reports then lockout on third attempt!');
