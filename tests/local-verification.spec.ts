...
test.describe('Local Changes Verification', () => {
  test('Verify all requested changes locally', async ({ page }) => {
    console.log('Testing all requested changes locally...');
    
    // Test Partners Page
    await page.goto('http://localhost:3000/partners?company=Apple&demo=1');
    ...
    // Test Support Page
    await page.goto('http://localhost:3000/support?company=Apple&demo=1');
    await page.waitForLoadState('domcontentloaded');
    await page.waitForTimeout(2000);
    ...
    await page.goto('http://localhost:3000/report?company=Apple&demo=1');
    await page.waitForLoadState('domcontentloaded');
    await page.waitForTimeout(2000);
    ...
    console.log('✓ All changes verified successfully locally!');
  });
});
