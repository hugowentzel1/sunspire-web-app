...
test('Live Site Brand Colors Test - Verify All Companies', async ({ page }) => {
  console.log('🎨 Testing brand colors on live site...');
  ...
  for (const company of companies) {
    ...
    console.log(`📝 ${company.name} page title:`, title);
    ...
    await page.screenshot({ path: `live-site-${company.name.toLowerCase()}-test.png` });
    console.log(`📸 ${company.name} screenshot saved`);
  }
  
  console.log('\n🎯 Brand colors test complete!');
});
