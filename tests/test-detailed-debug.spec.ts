...
test('Detailed Debug of Quota System', async ({ page }) => {
  console.log('🔍 Detailed debugging of quota system...');
  ...
  // Listen for console logs during the click
  page.on('console', msg => {
  ...
  console.log('  Third click:  Quota 0→0, Show lockout');
});
