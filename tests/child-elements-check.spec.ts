...
test.describe('Child Elements Check', () => {
  test('Check the colors of child elements in earnings text', async ({ page }) => {
    console.log('Checking child elements colors...');
    ...
    console.log('✓ Child elements check complete');
  });
});
