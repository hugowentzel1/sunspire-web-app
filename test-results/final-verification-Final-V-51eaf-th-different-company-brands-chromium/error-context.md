...
```yaml
- strong: Exclusive preview built for SolarPro
- text: "Exclusive preview — expires in 6:23:59:53 Runs left: 2"
- button "Launch on SolarPro"
- button "Copy link"
- button "Dismiss": ✕
- banner:
  - img "SolarPro logo"
  - heading "SolarPro" [level=1]
  ...
  - navigation:
    ...
    - button "Launch on SolarPro"
- main:
  - heading "Built for SolarPro" [level=2]
  - paragraph: Exclusive preview of your white-label solar intelligence tool
  - text: ⚡ Ready to launch on SolarPro.com
  - img "SolarPro logo"
  - text: ✓
  - heading "SolarPro Solar Intelligence — Live in 10 Minutes" [level=1]
  - paragraph: Embed a branded quote tool on SolarPro.com. Turn visitors into booked calls. 14-day refund if it doesn't lift conversions.
