...
- link "Put this on our site":
  - /url: /report?company=Tesla&demo=1
- button "Copy demo link"
- banner:
  - img "Tesla logo"
  - heading "Tesla" [level=1]
  ...
  - navigation:
    ...
    - link "Support":
      - /url: /support
    - button "Launch for Tesla"
  - paragraph: Private demo for Tesla. Not affiliated.
- main:
  ...
  - paragraph: Expires in 7d 0h 0m 0s
...
- contentinfo:
  - contentinfo:
    - heading "Tesla Solar Intelligence" [level=3]
