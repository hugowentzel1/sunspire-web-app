...
- link "Put this on our site":
  - /url: /report?company=TealEnergy&brandColor=%2300B3B3&demo=1
- button "Copy demo link"
- banner:
  - text: ☀️
  - heading "TealEnergy" [level=1]
  ...
  - navigation:
    ...
    - link "Support":
      - /url: /support
    - button "Launch on TealEnergy"
- main:
  - heading "Built for TealEnergy" [level=2]
  - paragraph: Exclusive preview of your white-label solar intelligence tool
  - text: ⚡ Ready to launch on TealEnergy.com T ✓
  - heading "TealEnergy Solar Intelligence — Live in 10 Minutes" [level=1]
  - paragraph: Embed a branded quote tool on TealEnergy.com. Turn visitors into booked calls. 14-day refund if it doesn't lift conversions.
