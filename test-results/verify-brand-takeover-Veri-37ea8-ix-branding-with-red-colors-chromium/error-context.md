...
- link "Put this on our site":
  - /url: /report?company=Netflix&brandColor=%23E50914&demo=1
...
- banner:
  ...
  - navigation:
    ...
    - link "Support":
      - /url: /support
    - button "Launch on Netflix"
- main:
  - heading "Built for Netflix" [level=2]
  - paragraph: Exclusive preview of your white-label solar intelligence tool
  - text: ⚡ Ready to launch on Netflix.com
  - img "Netflix logo"
  - text: ✓
  - heading "Netflix Solar Intelligence — Live in 10 Minutes" [level=1]
  - paragraph: Embed a branded quote tool on Netflix.com. Turn visitors into booked calls. 14-day refund if it doesn't lift conversions.
