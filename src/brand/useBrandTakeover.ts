    ...
    const processBrandTakeover = () => {
      ...
      if (urlEnabled) {
        ...
        if (companyName.toLowerCase() === "tesla") {
          themeColor = "#CC0000";
          console.log(
            "useBrandTakeover: Using hardcoded Tesla red:",
            themeColor,
          );
          ...
          themeColor = "#1877F2";
          console.log(
            "useBrandTakeover: Using hardcoded Meta blue:",
            themeColor,
          );
        } else {
        ...
        if (stored) {
          try {
            ...
            console.log(
              "useBrandTakeover: Days since stored:",
              daysSinceStored,
            );
            ...
            if (daysSinceStored < parsed.expireDays) {
              ...
              console.log(
                "useBrandTakeover: Stored state expired, using default",
              );
              setSt({
                enabled: false,
                brand: "Your Company",
