    ...
    <footer className="bg-gradient-to-b from-gray-50 via-white to-gray-100 border-t border-gray-200 mt-20">
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 text-center">
          {/* Company Logo & Name - Only show for paid version */}
          {hideMarketingLinks && (
          ...
          {/* Company Information - Only show for demo version */}
          {!hideMarketingLinks && (
            <div>
          ...
          {/* Contact Information - Only show for demo version */}
          {!hideMarketingLinks && (
            <div>
              <div className="space-y-3 text-sm text-gray-500">
                ...
                <div className="flex items-center justify-center space-x-4 mt-4">
                  <a
                    href="/security#gdpr"
                    className="inline-flex items-center px-3 py-1 text-white text-xs font-medium rounded-full transition-all duration-200 hover:shadow-lg"
                    style={{
                      background:
                        b.enabled && b.primary
            ...
            <div {...tid("footer-marketing-links")}>
              ...
              <div className="space-y-3">
                <a
                  ...
                  style={{ "--tw-hover-opacity": "0.8" } as React.CSSProperties}
                >
                  Pricing
                </a>
                <a
