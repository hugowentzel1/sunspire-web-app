...
export default function TrustRow() {
  ...
  return (
    ...
    >
      ...
      <span className="opacity-60 align-middle leading-none relative top-[1px]" aria-hidden>👥</span>
      ...
      <span className="text-neutral-300">•</span>
      <span className="opacity-60 align-middle leading-none relative top-[1px]" aria-hidden>🛡️</span>
      <span>GDPR</span>
      ...
      <span className="text-neutral-300">•</span>
      <span className="opacity-60 align-middle leading-none relative top-[1px] text-neutral-500" aria-hidden>★</span>
