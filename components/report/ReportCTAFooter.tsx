...
export default function ReportCTAFooter({
  ...
  return (
    ...
    >
      {/* Primary CTA */}
      <div className="cta-row flex flex-col sm:flex-row gap-3 justify-center items-center mb-4" style={{ marginLeft: '-9px' }}>
        <motion.button
          onClick={handleBook}
      ...
      {/* Utility actions row */}
      <div className="utility-row flex flex-col sm:flex-row gap-3 justify-center items-center pt-6 border-t border-gray-200" style={{ marginLeft: '9px' }}>
        <motion.button
