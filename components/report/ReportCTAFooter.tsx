...
export default function ReportCTAFooter({
  ...
  return (
    ...
    >
      ...
      {/* Utility actions row */}
      <div className="utility-row flex flex-col sm:flex-row gap-3 justify-center items-center pt-6 border-t border-gray-200" style={{ marginLeft: '-58px', height: '60px', paddingTop: '11px', paddingBottom: '1px' }}>
        <motion.button
