export type RateResult = { rate: number; source: "eia"|"state_fallback"|"generic"; state?: string; zip?: string };

const STATE_FALLBACK: Record<string, number> = {
  AL:0.14, AK:0.24, AZ:0.14, AR:0.12, CA:0.30, CO:0.16, CT:0.33, DC:0.16, DE:0.17,
  FL:0.15, GA:0.15, HI:0.44, IA:0.14, ID:0.11, IL:0.17, IN:0.15, KS:0.15, KY:0.13,
  LA:0.12, MA:0.32, MD:0.19, ME:0.27, MI:0.19, MN:0.16, MO:0.13, MS:0.14, MT:0.14,
  NC:0.15, ND:0.12, NE:0.12, NH:0.28, NJ:0.20, NM:0.15, NV:0.16, NY:0.25, OH:0.15,
  OK:0.12, OR:0.15, PA:0.17, RI:0.30, SC:0.15, SD:0.14, TN:0.13, TX:0.16, UT:0.12,
  VA:0.15, VT:0.26, WA:0.12, WI:0.18, WV:0.14, WY:0.12
};
...
export async function getRate(state?: string): Promise<RateResult> {
  ...
  if (state && STATE_FALLBACK[state]) return { rate: STATE_FALLBACK[state], source: "state_fallback", state };
